...
namespace EczaneStokUygulaması
{
    public partial class Form1 : Form
    {
        ...
        SqlConnection baglan = new SqlConnection("data source = DESKTOP-JLUCV90\\SQLEXPRESS;Initial Catalog=eczaneilacstok;Integrated Security=true");
        ...
        {
            baglan.Open();
            SqlConnection komut = new SqlConnection("select * from ilac");
            baglan.Close();
            verilerigörüntüle();
        }
    }
